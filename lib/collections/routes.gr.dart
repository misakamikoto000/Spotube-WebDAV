...
import 'package:spotube/pages/library/user_local_tracks/user_local_tracks.dart'
    as _i39;
import 'package:spotube/pages/library/user_local_tracks/webdav_browser.dart'
    as _i41;
...
/// generated route for
/// [_i41.WebDavBrowserPage]
class WebDavBrowserRoute extends _i42.PageRouteInfo<WebDavBrowserRouteArgs> {
  WebDavBrowserRoute({
    _i45.Key? key,
    required String accountId,
    List<_i42.PageRouteInfo>? children,
  }) : super(
         WebDavBrowserRoute.name,
         args: WebDavBrowserRouteArgs(key: key, accountId: accountId),
         initialChildren: children,
       );

  static const String name = 'WebDavBrowserRoute';

  static _i42.PageInfo page = _i42.PageInfo(
    name,
    builder: (data) {
      final args = data.argsAs<WebDavBrowserRouteArgs>();
      return _i41.WebDavBrowserPage(key: args.key, accountId: args.accountId);
    },
  );
}

class WebDavBrowserRouteArgs {
  const WebDavBrowserRouteArgs({this.key, required this.accountId});
  ...
  @override
  String toString() {
    return 'WebDavBrowserRouteArgs{key: $key, accountId: $accountId}';
  }
}
